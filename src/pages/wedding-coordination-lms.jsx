...
const STORE_KEY = "se_wec101_v1";
const ACADEMY_KEY = "se_academy_status_v1";
const COURSE_ID = "wec101";
const COURSE_TITLE = "Wedding and Event Coordination";
const COURSE_TYPE = "SKILLS PROGRAMME";
const COURSE_PRICE = 1750;

const MODULE_NAMES = ["The Coordinator's Role: Planning vs Coordination", "Understanding the Brief and the Client's Vision", "Reviewing the Run of Show and Event Documents", "The Day Before: Final Checks and Venue Walkthrough", "Team Briefing and Role Assignments", "Setup Day: Overseeing the Physical Preparation", "Guest Management and Arrival Coordination", "Managing Suppliers and Vendors on the Day", "Running the Programme: Cues, Timing and Transitions", "VIP and Principal Management on the Day", "Problem Solving and Managing the Unexpected", "Communication and Command During the Event", "Closing the Event: Guest Departure and Venue Handover", "The Day After: Breakdown, Returns and Post-Event Admin", "Debrief, Reporting and Building Client Relationships"];

const CHAPTERS = [{"id": 1, "title": "The Coordinator's Role: Planning vs Coordination", "subtitle": "Professional standards and application for the coordinator's role: planning vs coordination", "duration": "20 min", "slides": [{"title": "Introduction to The Coordinator's Role: Planning vs Coordination", "type": "intro", "body": "This module covers the coordinator's role: planning vs coordination as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of the coordinator's role: planning vs coordination in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for the coordinator's role: planning vs coordination:", "items": ["Maintain the highest professional standard in all aspects of the coordinator's role: planning vs coordination", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in the coordinator's role: planning vs coordination is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in the coordinator's role: planning vs coordination directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional the coordinator's role: planning vs coordination?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 2, "title": "Understanding the Brief and the Client's Vision", "subtitle": "Professional standards and application for understanding the brief and the client's vision", "duration": "20 min", "slides": [{"title": "Introduction to Understanding the Brief and the Client's Vision", "type": "intro", "body": "This module covers understanding the brief and the client's vision as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of understanding the brief and the client's vision in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for understanding the brief and the client's vision:", "items": ["Maintain the highest professional standard in all aspects of understanding the brief and the client's vision", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in understanding the brief and the client's vision is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in understanding the brief and the client's vision directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional understanding the brief and the client's vision?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 3, "title": "Reviewing the Run of Show and Event Documents", "subtitle": "Professional standards and application for reviewing the run of show and event documents", "duration": "20 min", "slides": [{"title": "Introduction to Reviewing the Run of Show and Event Documents", "type": "intro", "body": "This module covers reviewing the run of show and event documents as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of reviewing the run of show and event documents in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for reviewing the run of show and event documents:", "items": ["Maintain the highest professional standard in all aspects of reviewing the run of show and event documents", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in reviewing the run of show and event documents is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in reviewing the run of show and event documents directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional reviewing the run of show and event documents?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 4, "title": "The Day Before: Final Checks and Venue Walkthrough", "subtitle": "Professional standards and application for the day before: final checks and venue walkthrough", "duration": "20 min", "slides": [{"title": "Introduction to The Day Before: Final Checks and Venue Walkthrough", "type": "intro", "body": "This module covers the day before: final checks and venue walkthrough as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of the day before: final checks and venue walkthrough in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for the day before: final checks and venue walkthrough:", "items": ["Maintain the highest professional standard in all aspects of the day before: final checks and venue walkthrough", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in the day before: final checks and venue walkthrough is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in the day before: final checks and venue walkthrough directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional the day before: final checks and venue walkthrough?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 5, "title": "Team Briefing and Role Assignments", "subtitle": "Professional standards and application for team briefing and role assignments", "duration": "20 min", "slides": [{"title": "Introduction to Team Briefing and Role Assignments", "type": "intro", "body": "This module covers team briefing and role assignments as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of team briefing and role assignments in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for team briefing and role assignments:", "items": ["Maintain the highest professional standard in all aspects of team briefing and role assignments", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in team briefing and role assignments is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in team briefing and role assignments directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional team briefing and role assignments?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 6, "title": "Setup Day: Overseeing the Physical Preparation", "subtitle": "Professional standards and application for setup day: overseeing the physical preparation", "duration": "20 min", "slides": [{"title": "Introduction to Setup Day: Overseeing the Physical Preparation", "type": "intro", "body": "This module covers setup day: overseeing the physical preparation as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of setup day: overseeing the physical preparation in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for setup day: overseeing the physical preparation:", "items": ["Maintain the highest professional standard in all aspects of setup day: overseeing the physical preparation", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in setup day: overseeing the physical preparation is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in setup day: overseeing the physical preparation directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional setup day: overseeing the physical preparation?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 7, "title": "Guest Management and Arrival Coordination", "subtitle": "Professional standards and application for guest management and arrival coordination", "duration": "20 min", "slides": [{"title": "Introduction to Guest Management and Arrival Coordination", "type": "intro", "body": "This module covers guest management and arrival coordination as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of guest management and arrival coordination in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for guest management and arrival coordination:", "items": ["Maintain the highest professional standard in all aspects of guest management and arrival coordination", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in guest management and arrival coordination is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in guest management and arrival coordination directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional guest management and arrival coordination?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 8, "title": "Managing Suppliers and Vendors on the Day", "subtitle": "Professional standards and application for managing suppliers and vendors on the day", "duration": "20 min", "slides": [{"title": "Introduction to Managing Suppliers and Vendors on the Day", "type": "intro", "body": "This module covers managing suppliers and vendors on the day as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of managing suppliers and vendors on the day in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for managing suppliers and vendors on the day:", "items": ["Maintain the highest professional standard in all aspects of managing suppliers and vendors on the day", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in managing suppliers and vendors on the day is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in managing suppliers and vendors on the day directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional managing suppliers and vendors on the day?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 9, "title": "Running the Programme: Cues, Timing and Transitions", "subtitle": "Professional standards and application for running the programme: cues, timing and transitions", "duration": "20 min", "slides": [{"title": "Introduction to Running the Programme: Cues, Timing and Transitions", "type": "intro", "body": "This module covers running the programme: cues, timing and transitions as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of running the programme: cues, timing and transitions in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for running the programme: cues, timing and transitions:", "items": ["Maintain the highest professional standard in all aspects of running the programme: cues, timing and transitions", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in running the programme: cues, timing and transitions is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in running the programme: cues, timing and transitions directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional running the programme: cues, timing and transitions?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 10, "title": "VIP and Principal Management on the Day", "subtitle": "Professional standards and application for vip and principal management on the day", "duration": "20 min", "slides": [{"title": "Introduction to VIP and Principal Management on the Day", "type": "intro", "body": "This module covers vip and principal management on the day as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of vip and principal management on the day in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for vip and principal management on the day:", "items": ["Maintain the highest professional standard in all aspects of vip and principal management on the day", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in vip and principal management on the day is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in vip and principal management on the day directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional vip and principal management on the day?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 11, "title": "Problem Solving and Managing the Unexpected", "subtitle": "Professional standards and application for problem solving and managing the unexpected", "duration": "20 min", "slides": [{"title": "Introduction to Problem Solving and Managing the Unexpected", "type": "intro", "body": "This module covers problem solving and managing the unexpected as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of problem solving and managing the unexpected in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for problem solving and managing the unexpected:", "items": ["Maintain the highest professional standard in all aspects of problem solving and managing the unexpected", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in problem solving and managing the unexpected is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in problem solving and managing the unexpected directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional problem solving and managing the unexpected?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 12, "title": "Communication and Command During the Event", "subtitle": "Professional standards and application for communication and command during the event", "duration": "20 min", "slides": [{"title": "Introduction to Communication and Command During the Event", "type": "intro", "body": "This module covers communication and command during the event as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of communication and command during the event in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for communication and command during the event:", "items": ["Maintain the highest professional standard in all aspects of communication and command during the event", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in communication and command during the event is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in communication and command during the event directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional communication and command during the event?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 13, "title": "Closing the Event: Guest Departure and Venue Handover", "subtitle": "Professional standards and application for closing the event: guest departure and venue handover", "duration": "20 min", "slides": [{"title": "Introduction to Closing the Event: Guest Departure and Venue Handover", "type": "intro", "body": "This module covers closing the event: guest departure and venue handover as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of closing the event: guest departure and venue handover in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for closing the event: guest departure and venue handover:", "items": ["Maintain the highest professional standard in all aspects of closing the event: guest departure and venue handover", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in closing the event: guest departure and venue handover is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in closing the event: guest departure and venue handover directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional closing the event: guest departure and venue handover?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 14, "title": "The Day After: Breakdown, Returns and Post-Event Admin", "subtitle": "Professional standards and application for the day after: breakdown, returns and post-event admin", "duration": "20 min", "slides": [{"title": "Introduction to The Day After: Breakdown, Returns and Post-Event Admin", "type": "intro", "body": "This module covers the day after: breakdown, returns and post-event admin as a core component of professional skills programme work. By the end of this module you will understand the key principles, professional standards and practical application of the day after: breakdown, returns and post-event admin in real hospitality and events environments."}, {"title": "Key Principles", "type": "list", "intro": "The professional standards for the day after: breakdown, returns and post-event admin:", "items": ["Maintain the highest professional standard in all aspects of the day after: breakdown, returns and post-event admin", "Apply correct procedure consistently \u2014 not just when being observed", "Communicate clearly with guests, supervisors and team members", "Identify and address issues before they affect the guest experience", "Take ownership of your responsibilities without waiting to be directed"]}, {"title": "In Practice", "type": "highlight", "points": [{"text": "Excellence in the day after: breakdown, returns and post-event admin is built on preparation. Know what is required of you before the event or shift begins."}, {"text": "Consistency matters more than occasional perfection. Apply the same standard every time, regardless of the event size or pressure."}, {"text": "When faced with an unusual situation, ask your supervisor rather than guessing. A professional acknowledges the limits of their knowledge."}, {"text": "Your performance in the day after: breakdown, returns and post-event admin directly reflects on Sinotheni Events and the client whose event you are working at."}]}], "questions": [{"q": "What is the most important factor in professional the day after: breakdown, returns and post-event admin?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}, {"id": 15, "title": "Debrief, Reporting and Building Client Relationships", "subtitle": "Professional standards and application for debrief, reporting and building client relationships", "duration": "20 min", "slides": [{"title": "You Are Ready \u2014 Wedding and Event Coordination", "type": "intro", "body": "You have worked through all 15 modules of Wedding and Event Coordination. This final module brings together everything you have learned and prepares you for the final assessment.\n\nThe assessment covers all 15 modules. You need 60% or higher to pass and receive your Certificate of Completion from Sinotheni Events Training Academy."}, {"title": "What You Have Learned", "type": "list", "intro": "Through this course you have covered:", "items": ["Module 1: The Coordinator's Role: Planning vs Coordination", "Module 2: Understanding the Brief and the Client's Vision", "Module 3: Reviewing the Run of Show and Event Documents", "Module 4: The Day Before: Final Checks and Venue Walkthrough", "Module 5: Team Briefing and Role Assignments", "Module 6: Setup Day: Overseeing the Physical Preparation", "Module 7: Guest Management and Arrival Coordination", "Module 8: Managing Suppliers and Vendors on the Day"]}, {"title": "Before You Take the Assessment", "type": "highlight", "points": [{"text": "Review any modules you found challenging before attempting the final assessment."}, {"text": "The assessment has a time limit. Read each question carefully before selecting your answer."}, {"text": "You need 60% or higher to pass. If you do not pass on the first attempt, review the material and try again."}, {"text": "Your certificate downloads automatically once you pass. Save it and keep it for your professional records."}]}], "questions": [{"q": "What is the most important factor in professional debrief, reporting and building client relationships?", "opts": ["Speed and efficiency above all else", "Consistency \u2014 applying the correct standard every time regardless of conditions", "Making a good impression on the supervisor", "Following your own professional judgment without consultation"], "a": 1}, {"q": "When should you ask your supervisor for guidance?", "opts": ["Never \u2014 a professional always handles situations independently", "Only during formal briefings before the event", "Whenever you are in an unusual situation you are not confident handling alone", "Only after you have made a decision and need to report it"], "a": 2}, {"q": "What does professional consistency mean in practice?", "opts": ["Performing exactly the same physical actions in the same sequence every time", "Maintaining the same high professional standard on every shift regardless of event size", "Being consistent in your appearance only", "Performing well only at important events where clients are watching"], "a": 1}, {"q": "How does your performance on any shift affect Sinotheni Events?", "opts": ["Your individual performance only affects your own professional record", "It directly reflects on Sinotheni Events and the client whose event you are working at", "It only matters at large corporate or government events", "Individual performance is less important than team performance"], "a": 1}]}];

const FINAL_EXAM = [{"q": "What is the first priority when beginning any professional shift?", "opts": ["Completing paperwork", "Personal appearance and uniform check", "Introducing yourself to colleagues", "Setting up your station immediately"], "a": 1}, {"q": "When a guest makes a complaint, what is the first step?", "opts": ["Apologise and offer a solution immediately", "Listen completely without interrupting or defending", "Escalate to the supervisor", "Explain what went wrong"], "a": 1}, {"q": "What does 'serving from the left and clearing from the right' ensure?", "opts": ["Faster service during busy periods", "A consistent professional standard of table service", "The guest's comfort during the meal", "Proper communication between front and back of house"], "a": 1}, {"q": "How should a professional handle working under pressure?", "opts": ["Work faster and prioritise speed above quality", "Inform guests that service may be delayed", "Stay calm, prioritise correctly and ask for help when needed", "Complete your assigned tasks only"], "a": 2}, {"q": "What is the correct approach to dietary requirements and allergens?", "opts": ["Advise guests based on your knowledge of the menu", "Never confirm without checking with the kitchen directly", "Treat common dietary preferences as medically unnecessary", "Delegate dietary questions to the event manager"], "a": 1}, {"q": "When should a waiter clear plates from a table?", "opts": ["When the fastest guest at the table has finished", "At fixed time intervals regardless of guests", "When every guest at the table has finished eating", "When asked by the guest"], "a": 2}, {"q": "What does 'anticipating guest needs' mean in professional service?", "opts": ["Asking guests frequently what they need next", "Identifying what a guest will need before they have to ask", "Preparing all items in advance regardless of whether they are needed", "Following a fixed service sequence for every table"], "a": 1}, {"q": "When is it acceptable to use your phone during service?", "opts": ["During quiet periods between courses", "When you need to check a work-related message", "It is never acceptable to use your phone in guest areas during service", "When your supervisor is not nearby"], "a": 2}, {"q": "What should you do if you are uncertain about an instruction during a briefing?", "opts": ["Figure it out during the event", "Ask a colleague quietly during service", "Ask during the briefing before service begins", "Proceed based on past experience"], "a": 2}, {"q": "How do you build a professional reputation in hospitality and events?", "opts": ["By working only at premium events and venues", "By performing consistently at the professional standard on every shift over time", "By obtaining formal qualifications as quickly as possible", "By networking with event managers and clients"], "a": 1}, {"q": "In the context of the coordinator's role: planning vs coordination, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of understanding the brief and the client's vision, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of reviewing the run of show and event documents, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of the day before: final checks and venue walkthrough, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of team briefing and role assignments, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of setup day: overseeing the physical preparation, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of guest management and arrival coordination, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of managing suppliers and vendors on the day, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of running the programme: cues, timing and transitions, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of vip and principal management on the day, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of problem solving and managing the unexpected, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of communication and command during the event, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of closing the event: guest departure and venue handover, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of the day after: breakdown, returns and post-event admin, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}, {"q": "In the context of debrief, reporting and building client relationships, what is the professional standard?", "opts": ["Complete the minimum required tasks", "Apply the correct standard consistently on every shift", "Focus on speed over quality", "Follow your own judgment above training guidelines"], "a": 1}];

const RESOURCES = [{"filename": "WEC101_Resource_1.txt", "title": "Course Quick Reference Guide", "desc": "Key concepts and professional standards for Wedding and Event Coordination", "content": "SINOTHENI EVENTS TRAINING ACADEMY\\nWedding and Event Coordination Quick Reference\\n\\nModule 1: The Coordinator's Role: Planning vs Coordination\\nModule 2: Understanding the Brief and the Client's Vision\\nModule 3: Reviewing the Run of Show and Event Documents\\nModule 4: The Day Before: Final Checks and Venue Walkthrough\\nModule 5: Team Briefing and Role Assignments\\nModule 6: Setup Day: Overseeing the Physical Preparation\\nModule 7: Guest Management and Arrival Coordination\\nModule 8: Managing Suppliers and Vendors on the Day\\nModule 9: Running the Programme: Cues, Timing and Transitions\\nModule 10: VIP and Principal Management on the Day\\nModule 11: Problem Solving and Managing the Unexpected\\nModule 12: Communication and Command During the Event\\nModule 13: Closing the Event: Guest Departure and Venue Handover\\nModule 14: The Day After: Breakdown, Returns and Post-Event Admin\\nModule 15: Debrief, Reporting and Building Client Relationships"}]
