...
const RESOURCES = [{"id":"resource-pack","title":"Waiters 101 Practical Resource Pack","desc":"Practical workplace tools across 7 sections"}];
...
.page{width:297mm;height:210mm;background:#FAF7F2;position:relative;margin:56px auto 0;overflow:hidden;}
...
<body>
<div class="savebar">
  <p>To save your certificate: when the print dialog opens, set the destination to <strong>Save as PDF</strong> and the layout to <strong>Landscape</strong>.</p>
...
.page{width:210mm;height:297mm;background:#FAF7F2;position:relative;margin:56px auto 0;overflow:hidden;}
...
<body>
<div class="savebar">
  <p>To save your transcript: when the print dialog opens, set destination to <strong>Save as PDF</strong>.</p>
  <button onclick="window.print()">Save as PDF</button>
</div>
<div class="page">
  <div class="b-outer"></div>
...
<body>
<div class="savebar">
  <p>To save as PDF: when the print dialog opens, set destination to <strong>Save as PDF</strong>.</p>
  <button onclick="window.print()">Save as PDF</button>
</div>
<div class="page">
  <div class="phdr">
...
function resourcePackHTML() {
  ...
  const np = '<div style="page-break-before:always;"></div>';
  ...
  const coverHtml = `<div style="background:#0A0A0A;width:210mm;height:297mm;display:flex;flex-direction:column;align-items:center;justify-content:space-between;padding:16mm 12mm;text-align:center;position:relative;">
...
<body>
<div class="savebar">
  <p>To save as PDF: when the print dialog opens, set destination to <strong>Save as PDF</strong>. This pack is multiple pages.</p>
  <button onclick="window.print()">Save as PDF</button>
</div>
